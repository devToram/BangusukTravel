  ...
  map = new google.maps.Map(document.getElementById('map'), mapOptions);
    ...
    panorama.addListener("position_changed", () => { // 관광한 곳에 찍기 
      ...
      if(temp ==0 ){
        ...
        fetch(
          'https://api.openweathermap.org/data/2.5/weather?lat='+String(CurLat)+'&lon='+String(Curlon)+'&appid=YOUR_KEY&units=metric'
        )
...
$(function(){
  ...
  //     });
      ...
      .then(canvas => saveAs(canvas.toDataURL('image/jpg'),place_name+".jpg"))
      ;
    // console.log("~")
